...
static u8 rpcbuf[128] __attribute__((aligned(64)));
...
int ds34usb_get_raw_report(int port, u8 *data)
{
    int ret;
    ...
    ret = (SifCallRpc(&ds34usb, DS34USB_GET_RAW, 0, rpcbuf, 1, rpcbuf, 72, NULL, NULL) == 0);

    memcpy(data, rpcbuf, 72);
